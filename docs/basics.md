...
<tr class="odd">
<td>status</td>
<td>HRHIS4 status, possible values are <em>OK</em> | <em>WARNING</em> | <em>ERROR</em>, where `OK` means everything was successful, `ERROR` means that operation did not complete and `WARNING` means the operation was partially successful, if the message contains a `response` property, please look there for more information.</td>
</tr>
<tr class="even">
<td>message</td>
...
<tr class="odd">
<td>ID, UID</td>
<td>Match on HRHIS4 stable Identifier, this is the default id scheme.</td>
</tr>
<tr class="even">
<td>CODE</td>
<td>Match on HRHIS4 Code, mainly used to exchange data with an external system.</td>
</tr>
<tr class="odd">
<td>NAME</td>
<td>Match on HRHIS4 Name, please note that this uses what is available as <em>object.name</em>, and not the translated name. Also note that names are not always unique, and in that case, they can not be used.</td>
</tr>
<tr class="even">
<td>ATTRIBUTE:ID</td>
...
<!--HRHIS4-SECTION-ID:webapi_translation-->

HRHIS4 supports translations of database content, such as data elements,
...
<!--HRHIS4-SECTION-ID:webapi_translation_api-->
...
<!--HRHIS4-SECTION-ID:webapi_api_versions-->

The Web API is versioned starting from DHIS 2.25. The API versioning
follows the HRHIS4 major version numbering. As an example, the API
...
will be documented in the HRHIS4 major version release notes.
...
<!--HRHIS4-SECTION-ID:webapi_metadata_logical_operator-->
...
<!--HRHIS4-SECTION-ID:webapi_field_transformers-->

In HRHIS4.17 we introduced field transformers, the idea is to allow
...
<!--HRHIS4-SECTION-ID:webapi_field_transformers_examples-->
...
```xml
<constant name="PI" xmlns="http://HRHIS4.org/schema/dxf/2.0">
...
```bash
curl -d @constant.json "https://play.HRHIS4.org/api/constants" -X POST
...
<!--HRHIS4-SECTION-ID:webapi_adding_removing_objects_collections-->
...
<!--HRHIS4-SECTION-ID:webapi_collections_adding_removing_single_objects-->
...
<!--HRHIS4-SECTION-ID:webapi_collections_adding_removing_multiple_objects-->
...
<!--HRHIS4-SECTION-ID:webapi_collections_adding_removing_objects_single_request-->
...
<!--HRHIS4-SECTION-ID:webapi_validating_payloads-->
...
curl -X POST -d "{\"name\": \"some name\"}" -H "Content-Type: application/json"
  -u admin:district "https://dev.hrhis.dhis2udsm.org/api/schemas/dataElement"
```
...
<!--HRHIS4-SECTION-ID:webapi_partial_updates-->
...
curl -X PATCH -d @file.json -H "Content-Type: application/json"
  -u admin:district "https://dev.hrhis.dhis2udsm.org/api/dataElements/fbfJHSPpUQD"
```

## Metadata export

<!--HRHIS4-SECTION-ID:webapi_metadata_export-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_export_examples-->
...
<!--HRHIS4-SECTION-ID:webapi_dataset_program_export_dependencies-->

When you want to exchange metadata for a data set, program or category combo
from one HRHIS4 instance to another instance there are three dedicated endpoints available:
...
<!--HRHIS4-SECTION-ID:webapi_metadata_import-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_audit-->

If you need information about who created, edited, or deleted HRHIS4
...
<!--HRHIS4-SECTION-ID:webapi_metadata_audit_query-->

If you have enabled persisted metadata audits on your HRHIS4 instance,
...
<!--HRHIS4-SECTION-ID:webapi_render_type-->
...
<!--HRHIS4-SECTION-ID:webapi_object_style-->
...
<!--HRHIS4-SECTION-ID:webapi_amqp_integration-->

By default HRHIS4 will start up an embedded instance of ActiveMQ Artemis when the
...
<table>
  ...
  <tbody>
    <tr class="odd">
      ...
      HRHIS4 instance is starting up. If you want to connect to an external AMQP service
...
<!--HRHIS4-SECTION-ID:webapi_csv_data_elements-->
...
<!--HRHIS4-SECTION-ID:webapi_csv_org_units-->
...
<!--HRHIS4-SECTION-ID:webapi_csv_validation_rules-->
...
<!--HRHIS4-SECTION-ID:webapi_csv_option_sets-->
...
<!--HRHIS4-SECTION-ID:webapi_csv_other_objects-->
...
<!--HRHIS4-SECTION-ID:webapi_deleted_objects-->
...
<!--HRHIS4-SECTION-ID:webapi_favorites-->
...
<!--HRHIS4-SECTION-ID:webapi_subscription-->
...
<!--HRHIS4-SECTION-ID:webapi_file_resources-->
...
<!--HRHIS4-SECTION-ID:webapi_file_resources_constraints-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_versioning-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_versioning_examples-->
...
<!--HRHIS4-SECTION-ID:webapi_get_list_of_metadata_versions-->
...
<!--HRHIS4-SECTION-ID:webapi_create_metadata_version-->
...
```bash
curl -X POST -u admin:district "https://dev.hrhis.dhis2udsm.org/api/metadata/version/create?type=BEST_EFFORT"
```
...
<!--HRHIS4-SECTION-ID:webapi_download_version_metadata-->
...
```bash
curl -u admin:district "https://dev.hrhis.dhis2udsm.org/api/metadata/version/Version_5/data"
```
...
<!--HRHIS4-SECTION-ID:webapi_metadata_synchronization-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_synchronization_version-->
...
```bash
curl -u admin:district "https://dev.hrhis.dhis2udsm.org/api/metadata/sync?versionName=Version_6"
```

## Data values

<!--HRHIS4-SECTION-ID:webapi_data_values-->
...
<!--HRHIS4-SECTION-ID:webapi_sending_data_values-->
...
use the HRHIS4 demo on `http://play.HRHIS4.org/demo` as basis. We assume
...
base URL to the demo API is `http://play.HRHIS4.org/demo/api`. The following
...
```xml
<dataValueSet xmlns="http://HRHIS4.org/schema/dxf/2.0" dataSet="dataSetID"
...
```bash
curl -d @datavalueset.xml "https://play.HRHIS4.org/demo/api/dataValueSets"
...
```bash
curl -d @datavalueset.json "https://play.HRHIS4.org/demo/api/dataValueSets"
  -H "Content-Type:application/json" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_sending_bulks_data_values-->
...
```xml
<dataValueSet xmlns="http://HRHIS4.org/schema/dxf/2.0">
...
```bash
curl --data-binary @datavalueset.csv "https://play.HRHIS4.org/demo/24/api/dataValueSets"
  -H "Content-Type:application/csv" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_data_values_import_parameters-->
...
```xml
<dataValueSet xmlns="http://HRHIS4.org/schema/dxf/2.0" dataElementIdScheme="code"
...
<!--HRHIS4-SECTION-ID:webapi_data_values_import_requirement-->
...
<!--HRHIS4-SECTION-ID:webapi_data_values_identifier_schemes-->

Regarding the id schemes, by default the identifiers used in the XML
messages use the HRHIS4 stable object identifiers referred to as `UID`.
...
<!--HRHIS4-SECTION-ID:webapi_data_values_async_import-->
...
<!--HRHIS4-SECTION-ID:webapi_data_values_csv-->

The following section describes the CSV format used in HRHIS4. The first
row is assumed to be a header row and will be ignored during import.

<table>
<caption>CSV format of HRHIS4</caption>
<tbody>
<tr class="odd">
<td>Column</td>
<td>Required</td>
...
An example of a CSV file which can be imported into HRHIS4 is seen below.
...
<!--HRHIS4-SECTION-ID:webapi_data_values_template-->
...
<!--HRHIS4-SECTION-ID:webapi_reading_data_values-->
...
Assuming that we have posted data values to HRHIS4 according to the
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataValueSets?dataSet=pBOMPrpg1QX&period=201401&orgUnit=DiszpKrYNg8"
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataValueSets?dataSet=pBOMPrpg1QX&dataSet=BfMAe6Itzgt
...
<!--HRHIS4-SECTION-ID:webapi_sending_individual_data_values-->
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataValues?de=s46m5MS0hxu
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataValues?de=s46m5MS0hxu&ou=DiszpKrYNg8
...
<!--HRHIS4-SECTION-ID:datavalue_file-->
...
<!--HRHIS4-SECTION-ID:webapi_adx_data_format-->
...
trial implementation. Note that what is implemented currently in HRHIS4
...
is using codes as identifiers instead of HRHIS4 uids. Codes are the
preferred form of identifier when using adx.

The orgUnit, period and dataSet attributes are mandatory in adx. The
group element may contain additional attributes. In our HRHIS4
...
flexible and allows us to support all existing period types in HRHIS4

### ADX period definitions

HRHIS4 supports a limited number of periods or durations during import.
...
Currently, the convention is not enforced by HRHIS4 when you are assigning
...
that
  ...
  - The system producing the data does not have to be synchronised with the
    categoryOptionCombo within HRHIS4.
...
HRHIS4 implementation of adx will check for the existence of a
...
HRHIS4 exposes an endpoint for POST adx data at `/api/dataValueSets`
...
curl -u admin:district -X POST -H "Content-Type: application/adx+xml"
  -d @data.xml "https://play.HRHIS4.org/demo/api/dataValueSets?dataElementIdScheme=code&orgUnitIdScheme=code"
```
...
HRHIS4 exposes an endpoint to GET adx data sets at `/api/dataValueSets`
...
curl -u admin:district -H "Accept: application/adx+xml"
 "https://play.HRHIS4.org/demo/api/dataValueSets?dataValueSets?orgUnit=M_CLINIC&dataSet=MALARIA&period=201501"
```
...
<!--HRHIS4-SECTION-ID:webapi_program_rules-->
...
configure dynamic behaviour in the programs in HRHIS4.

### Program rule model

<!--HRHIS4-SECTION-ID:webapi_program_rule_model-->
...
<tr class="even">
<td>name</td>
<td>The name with which the program rule will be displayed to HRHIS4 configurators. Not visible to the end user of the program.</td>
<td>Compulsory</td>
</tr>
<tr class="odd">
<td>description</td>
...
<!--HRHIS4-SECTION-ID:webapi_creating_program_rules-->
...
<!--HRHIS4-SECTION-ID:webapi_documents-->
...
<!--HRHIS4-SECTION-ID:webapi_validation-->
...
<!--HRHIS4-SECTION-ID:webapi_validation_results-->
...
api endpoint:
    ...
    /api/validation/sendNotifications

Only unsent results are sent using this endpoint.

## Data analysis

<!--HRHIS4-SECTION-ID:webapi_data_analysis-->
...
<!--HRHIS4-SECTION-ID:webapi_data_analysis_validation_rules-->
...
<!--HRHIS4-SECTION-ID:webapi_data_analysis_std_dev_outlier-->
...
<!--HRHIS4-SECTION-ID:webapi_data_analysis_min_max_outlier-->
...
<!--HRHIS4-SECTION-ID:webapi_data_integrity-->
...
<!--HRHIS4-SECTION-ID:webapi_data_integrity_run-->
...
```bash
curl -X POST "https://localhost/api/dataIntegrity"
```
...
<!--HRHIS4-SECTION-ID:webapi_data_integrity_fetch_results-->

Once data integrity is finished running the result can be fetched from
the `system/taskSummaries` resource like so:

```bash
curl "https://dhis.domain/api/system/taskSummaries/DATAINTEGRITY"
```
...
<!--HRHIS4-SECTION-ID:webapi_indicators-->

This section describes indicators and indicator expressions.

### Aggregate indicators

<!--HRHIS4-SECTION-ID:webapi_aggregate_indicators-->
...
<!--HRHIS4-SECTION-ID:webapi_program_indicators-->
...
<!--HRHIS4-SECTION-ID:webapi_expressions-->
...
<!--HRHIS4-SECTION-ID:webapi_complete_data_set_registrations-->
...
<!--HRHIS4-SECTION-ID:webapi_completing_data_sets-->
...
```xml
<completeDataSetRegistrations xmlns="http://HRHIS4.org/schema/dxf/2.0">
...
<!--HRHIS4-SECTION-ID:webapi_reading_complete_data_sets-->
...
```bash
curl "https://play.HRHIS4.org/demo/api/completeDataSetRegistrations?dataSet=pBOMPrpg1QX
...
<!--HRHIS4-SECTION-ID:webapi_uncompleting_data_sets-->
...
<!--HRHIS4-SECTION-ID:webapi_data_approval-->
...
<!--HRHIS4-SECTION-ID:webapi_data_approval_get_status-->
...
<!--HRHIS4-SECTION-ID:webapi_data_approval_approve_data-->
...
*DELETE* request to the *dataAcceptances* resource.
    ...
    POST DELETE /api/dataAcceptances
...
<!--HRHIS4-SECTION-ID:webapi_auditing-->

HRHIS4 does automatic auditing on all updates and deletions of aggregate
...
<!--HRHIS4-SECTION-ID:webapi_auditing_aggregate_audits-->
...
Get all audits for data set with ID *lyLU2wR22tC*:
    ...
    /api/audits/dataValue?ds=lyLU2wR22tC

### Tracked entity data value audits

<!--HRHIS4-SECTION-ID:webapi_tracked_entity_data_value_audits-->
...
Get all audits which have data element ID eMyVanycQSC or qrur9Dvnyt5:
    ...
    /api/audits/trackedEntityDataValue?de=eMyVanycQSC&de=qrur9Dvnyt5

### Tracked entity attribute value audits

<!--HRHIS4-SECTION-ID:webapi_tracked_entity_attribute_value_audits-->
...
Get all audits which have attribute with ID VqEFza8wbwA:
    ...
    /api/audits/trackedEntityAttributeValue?tea=VqEFza8wbwA

### Tracked entity instance audits

<!--HRHIS4-SECTION-ID:webapi_tracked_entity_instance_audits-->
...
startDate=2018-03-01 and endDate=2018-04-24 in a page size of 5:
    ...
    /api/audits/trackedEntityInstance.json?startDate=2018-03-01
      &endDate=2018-04-24&auditType=READ&pageSize=5

### Enrollment audits

<!--HRHIS4-SECTION-ID:webapi_enrollment_audits-->
...
Get all audits for data approval workflow RwNpkAM7Hw7:
    ...
    /api/audits/dataApproval?wf=RwNpkAM7Hw7
...
entry point at <http://play.HRHIS4.org/demo/api> where we find and follow
the link to the *messageConversations* resource at
<http://play.HRHIS4.org/demo/api/messageConversations>. The description
...
```bash
curl -d @message.xml "https://play.HRHIS4.org/demo/api/messageConversations"
...
```bash
curl -d @message.json "https://play.HRHIS4.org/demo/api/messageConversations"
...
```bash
curl "https://play.HRHIS4.org/demo/api/messageConversations"
...
<messageConversations xmlns="http://HRHIS4.org/schema/dxf/2.0"
  link="https://play.HRHIS4.org/demo/api/messageConversations">
  <messageConversation name="Mortality data reporting" id="ZjHHSjyyeJ2"
    link="https://play.HRHIS4.org/demo/api/messageConversations/ZjHHSjyyeJ2"/>
  <messageConversation name="HRHIS4 version 2.7 is deployed" id="GDBqVfkmnp2"
    link="https://play.HRHIS4.org/demo/api/messageConversations/GDBqVfkmnp2"/>
...
curl -d "Yes the Mortality data set has been reported"
  "https://play.HRHIS4.org/demo/api/messageConversations/ZjHHSjyyeJ2"
...
```bash
curl "https://play.HRHIS4.org/demo/api/messageConversations/jMe43trzrdi
```
...
```bash
curl "https://play.HRHIS4.org/demo/api/messageConversations?mc=WzMRrCosqc0&mc=lxCjiigqrJm"
...
```bash
curl "https://play.HRHIS4.org/demo/api/messageConversations?mc=WzMRrCosqc0&mc=lxCjiigqrJm&user=PhzytPW3g2J"
  -X DELETE -u admin:district
```
...
```
curl -F file=@attachment.png "https://play.HRHIS4.org/demo/api/messageConversations/attachments"
  -u admin:district 
```
...
```bash
curl -d "Yes the Mortality data set has been reported"
  "https://play.HRHIS4.org/demo/api/messageConversations/ZjHHSjyyeJ2?attachments=fTpI4GOmujz,h2ZsOxMFMfq"
  -H "Content-Type:text/plain" -u mobile:district -X POST
```
...
curl -d "This is an internal message"
  "https://play.HRHIS4.org/demo/api/messageConversations/ZjHHSjyyeJ2?internal=true"
  -H "Content-Type:text/plain" -u admin:district -X POST
```

## Interpretations

<!--HRHIS4-SECTION-ID:webapi_interpretations-->

For resources related to data analysis in HRHIS4, such as pivot tables,
...
<!--HRHIS4-SECTION-ID:webapi_reading_interpretations-->
...
following URL:
    ...
    https://play.HRHIS4.org/demo/api/maps/bhmHJ4ZCdCd/data
...
<!--HRHIS4-SECTION-ID:webapi_writing_interpretations-->
...
curl -d "This chart shows a significant ANC 1-3 dropout" -X POST
  "https://play.HRHIS4.org/demo/api/interpretations/chart/EbRN2VIbPdV"
...
<!--HRHIS4-SECTION-ID:webapi_updating_removing_interpretations-->
...
curl -d "This charts shows a high dropout" -X PUT
  "https://play.HRHIS4.org/demo/api/interpretations/chart/EV08iI1cJRA"
  -H "Content-Type:text/plain" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_creating_interpretation_comments-->
...
curl -d "An intervention is needed" -X POST
  "https://play.HRHIS4.org/demo/api/interpretations/j8sjHLkK8uY/comments"
  -H "Content-Type:text/plain" -u admin:district
```

### Updating and removing interpretation comments

<!--HRHIS4-SECTION-ID:webapi_updating_removing_interpretation_comments-->
...
```bash
curl "https://play.HRHIS4.org/demo/api/interpretations/j8sjHLkK8uY/comments/idAzzhVWvh2"
...
<!--HRHIS4-SECTION-ID:webapi_liking_interpretations-->
...
<!--HRHIS4-SECTION-ID:webapi_viewing_analytical_resource_representations-->

HRHIS4 has several resources for data analysis. These resources include
...
<!--HRHIS4-SECTION-ID:webapi_plugins-->

HRHIS4 comes with plugins which enable you to embed live data directly in
...
proxy](https://docs.HRHIS4.org/master/en/implementer/html/install_reverse_proxy_configuration.html#install_making_resources_available_with_nginx)
configuration.

### Embedding pivot tables with the Pivot Table plug-in

<!--HRHIS4-SECTION-ID:webapi_pivot_table_plugin-->

In this example, we will see how we can embed good-looking, light-weight
html pivot tables with data served from a HRHIS4 back-end into a Web
...
<http://play.HRHIS4.org/portal/table.html>. Open the page in a web
...
<html>
<head>
  <script src="https://HRHIS4-cdn.org/v227/plugin/jquery-2.2.4.min.js"></script>
  <script src="https://HRHIS4-cdn.org/v227/plugin/reporttable.js"></script>

  <script>
    reportTablePlugin.url = "https://play.HRHIS4.org/demo";
...
first file is the jQuery JavaScript library (we use the HRHIS4 content
delivery network in this case). The second file is the Pivot table
plug-in. Make sure the path is pointing to your HRHIS4 server
installation.
...
you want to refer to pre-defined tables already made inside HRHIS4 it is
...
<td>Yes</td>
<td></td>
<td>Base URL of the HRHIS4 server</td>
</tr>
<tr class="even">
<td>username</td>
<td>string</td>
...
<td>No</td>
<td></td>
<td>Identifier of a pre-defined table (favorite) in HRHIS4</td>
</tr>
<tr class="odd">
<td>columns</td>
<td>array</td>
...
<!--HRHIS4-SECTION-ID:webapi_chart_plugin-->

In this example, we will see how we can embed good-looking Highcharts
charts (<http://www.highcharts.com>) with data served from a HRHIS4
back-end into a Web page. To accomplish this we will use the HRHIS4
...
<http://play.HRHIS4.org/portal/chart.html>. Open the page in a web
browser and view the source to see how it is set up.
...
<head>
  <script src="https://HRHIS4-cdn.org/v227/plugin/jquery-2.2.4.min.js"></script>
  <script src="https://HRHIS4-cdn.org/v227/plugin/chart.js"></script>

  <script>
    chartPlugin.url = "https://play.HRHIS4.org/demo";
...
property is required: *el* (please refer to the table below). Now, if
you want to refer to pre-defined charts already made inside HRHIS4 it is
sufficient to provide the additional *id* parameter. If you instead want
...
<!--HRHIS4-SECTION-ID:webapi_map_plugin-->

In this example we will see how we can embed maps with data served from
a HRHIS4 back-end into a Web page. To accomplish this we will use the GIS
...
<http://play.HRHIS4.org/portal/map.html>. Open the page in a web browser
...
<html>
<head>
  <link rel="stylesheet" type="text/css" href="http://HRHIS4-cdn.org/v215/ext/resources/css/ext-plugin-gray.css" />
  <script src="http://HRHIS4-cdn.org/v215/ext/ext-all.js"></script>
  <script src="https://maps.google.com/maps/api/js?sensor=false"></script>
  <script src="http://HRHIS4-cdn.org/v215/openlayers/OpenLayers.js"></script>
  <script src="http://HRHIS4-cdn.org/v215/plugin/map.js"></script>

  <script>
    var base = "https://play.HRHIS4.org/demo";
...
use the HRHIS4 content delivery network in this case) and its stylesheet.
...
Make sure the path is pointing to your HRHIS4 server
    installation.
...
To authenticate with the HRHIS4 server we use the same approach as in the
...
the HRHIS4 GIS it is sufficient to provide the additional *id* parameter.
...
the Web API here: <http://play.HRHIS4.org/demo/api/maps>.
...
<http://play.HRHIS4.org/portal/map.html>.

### Creating a chart carousel with the carousel plug-in

<!--HRHIS4-SECTION-ID:webapi_carousel_plugin-->
...
```html
<link rel="stylesheet" type="text/css" href="http://HRHIS4-cdn.org/v213/ext/resources/css/ext-plugin-gray.css" />
<link rel="stylesheet" type="text/css" href="https://play.HRHIS4.org/demo/dhis-web-commons/javascripts/ext-ux/carousel/css/carousel.css" />
<script type="text/javascript" src="https://extjs-public.googlecode.com/svn/tags/extjs-4.0.7/release/ext-all.js"></script>
<script type="text/javascript" src="https://play.HRHIS4.org/demo/dhis-web-commons/javascripts/ext-ux/carousel/Carousel.js"></script>
<script type="text/javascript" src="https://play.HRHIS4.org/demo/dhis-web-commons/javascripts/plugin/plugin.js"></script>
```
...
HRHIS4 demo site, make sure you update them to point to your own HRHIS4
installation.
...
To see a complete working example please visit
<http://play.HRHIS4.org/portal/carousel.html>.
...
```bash
curl "https://play.HRHIS4.org/demo/api/sqlViews/dI68mLkP1wN/execute" -X POST -u admin:district
```
...
```bash
curl "https://play.HRHIS4.org/demo/api/sqlViews/dI68mLkP1wN/data.csv" -u admin:district
```
...
organisation units at level 4 you can use the following
    ...
    https://play.HRHIS4.org/demo/api/sqlViews/dI68mLkP1wN/data.csv?criteria=level:4
...
```json
{
  ...
  "href": "https://play.HRHIS4.org/demo/api/dashboards/vQFhmLJU5sK",
  "publicAccess": "--------",
  "externalAccess": false,
  "itemCount": 17,
  ...
  "user": {
    ...
    "href": "https://play.HRHIS4.org/demo/api/users/xE7jOejl9FI"
  },
  "dashboardItems": [{
    "id": "bu1IAnPFa9H",
...
```bash
curl "play.HRHIS4.org/demo/api/analytics.json?dimension=dx:eTDtyyaSA7f;FbKK4ofIv5R
...
<!--HRHIS4-SECTION-ID:webapi_push_analysis-->
...
```bash
curl "play.HRHIS4.org/demo/api/dataStatistics?startDate=2016-02-01&endDate=2016-02-14
...
<!--HRHIS4-SECTION-ID:webapi_locales-->

HRHIS4 supports translations both for the user interface and for database
content.
...
<!--HRHIS4-SECTION-ID:webapi_translations-->

HRHIS4 allows for translations of database content. You can work with
...
locale you can use this request:
    ...
    /api/translations.json?fields=*&filter=className:eq:DataElement&filter=locale:eq:es

To get translations for a specific object for all properties:

    /api/translations.json?fields=*&filter=className:eq:DataElement
...
<!--HRHIS4-SECTION-ID:webapi_sms_commands-->
...
<!--HRHIS4-SECTION-ID:webapi_program_messages-->
...
<td>storeCopy</td>
<td>No</td>
<td>Whether to store a copy of the program message in HRHIS4.</td>
...
```bash
curl -d @message.json "https://play.HRHIS4.org/demo/api/messages"
  -H "Content-Type:application/json" -u admin:district
```
...
<tr class="odd">
<td>programInstance</td>
<td>/api/messages?programInstance=6yWDMa0LP7</td>
</tr>
<tr class="even">
<td>programStageInstance</td>
<td>/api/messages?programStageInstance=SllsjpfLH2</td>
</tr>
<tr class="odd">
<td>trackedEntityInstance</td>
<td>/api/messages?trackedEntityInstance=xdfejpfLH2</td>
</tr>
<tr class="even">
<td>organisationUnit</td>
<td>/api/messages?ou=Sllsjdhoe3</td>
</tr>
<tr class="odd">
<td>processedDate</td>
<td>/api/messages?processedDate=2016-02-01</td>
</tr>
</tbody>
</table>
...
<!--HRHIS4-SECTION-ID:webapi_users-->
...
```bash
curl "play.HRHIS4.org/demo/api/systemSettings/my-key" -d "My long value"
  -H "Content-Type: text/plain" -u admin:district
```
...
```bash
curl "play.HRHIS4.org/demo/api/systemSettings?key=keyApplicationNotification&key=keyApplicationIntro"
  -u admin:district
```
...
<td>The application title. Default: &quot;HRHIS4&quot;</td>
<td>Yes</td>
</tr>
<tr class="even">
...
<td>Google API recaptcha secret. Default: HRHIS4 play instance API secret, but this will only works on you local instance and not in production.</td>
<td>No</td>
</tr>
<tr class="odd">
<td>recaptchaSite</td>
<td>Google API recaptcha site. Default: HRHIS4 play instance API site, but this will only works on you local instance and not in production.</td>
<td>No</td>
</tr>
<tr class="even">
...
<tr class="even">
<td>helpPageLink</td>
<td>Link to help page. Default: &quot;<a href="http://HRHIS4.github.io/HRHIS4-docs/master/en/user/html/HRHIS4_user_manual_en.html">https://HRHIS4.github.io/HRHIS4-docs/master/en/user/html/HRHIS4_user_manual_en.html</a></td>
<td>No</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>keyStyle</td>
<td>The style used on the HRHIS4 webpages. Default: &quot;light_blue/light_blue.css&quot;.</td>
<td>No</td>
</tr>
<tr class="odd">
...
<td>Username used to connect to remote HRHIS4 instance</td>
<td>No</td>
</tr>
<tr class="odd">
<td>keyRemoteInstancePassword</td>
<td>Password used to connect to remote HRHIS4 instance</td>
<td>No</td>
</tr>
<tr class="even">
...
```bash
curl "https://play.HRHIS4.org/demo/api/userSettings/my-key" -d "My long value"
  -H "Content-Type: text/plain" -u admin:district
```
...
```bash
curl "https://play.HRHIS4.org/demo/api/userSettings/keyUiLocale?value=fr" 
  -X POST -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_organisation_units-->

The *organisationUnits* resource follows the standard conventions as
other metadata resources in HRHIS4. This resource supports some
additional query parameters.

### Get list of organisation units

<!--HRHIS4-SECTION-ID:webapi_list_of_organisation_units-->
...
<!--HRHIS4-SECTION-ID:webapi_organisation_units_with_relations-->
...
<!--HRHIS4-SECTION-ID:webapi_data_sets-->

The *dataSets* resource follows the standard conventions as other
metadata resources in HRHIS4. This resource supports some additional
query parameters.
...
<!--HRHIS4-SECTION-ID:webapi_filled_organisation_unit_levels-->
...
list to fill positions for which it does not exist a persisted level.
    ...
    GET /api/filledOrganisationUnitLevels
...
```bash
curl "http://localhost/api/filledOrganisationUnitLevels" -H "Content-Type:application/json"
  -d @levels.json -u admin:district
```

## Static content

<!--HRHIS4-SECTION-ID:webapi_static_content-->

The *staticContent* resource allows you to upload and retrieve custom
logos used in HRHIS4. The resource lets the user upload a file with an
...
```bash
curl -F "file=@logo.png;type=image/png" "https://play.HRHIS4.org/demo/api/staticContent/logo_front"
...
```bash
curl "https://play.HRHIS4.org/demo/api/staticContent/logo_front" 
...
```bash
curl -d @keys.json "play.HRHIS4.org/demo/api/i18n" -X POST
  -H "Content-Type: application/json" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_svg_conversion-->
...
<!--HRHIS4-SECTION-ID:webapi_tracker_api-->
...
<!--HRHIS4-SECTION-ID:webapi_tracked_entity_instance_management-->
...
<!--HRHIS4-SECTION-ID:webapi_creating_tei-->
...
```bash
curl -d @tei.json "https://play.HRHIS4.org/demo/api/trackedEntityInstances" -X POST
  -H "Content-Type: application/json" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_updating_tei-->
...
<!--HRHIS4-SECTION-ID:webapi_deleting_tei-->
...
<!--HRHIS4-SECTION-ID:webapi_create_enroll_tei-->
...
curl -X POST -d @tei.json -H "Content-Type: application/json"
  -u user:pass "http://server/api/trackedEntityInstances"
```

#### Complete example of payload including: tracked entity instance, enrollment and event

<!--HRHIS4-SECTION-ID:webapi_create_enroll_tei_create_event-->
...
<!--HRHIS4-SECTION-ID:webapi_generate_tei_attributes-->
...
<!--HRHIS4-SECTION-ID:webapi_generate_values-->
...
<!--HRHIS4-SECTION-ID:webapi_generate_reserve_values-->
...
```bash
curl "http://server/api/trackedEntityInstances/ZRyCnJ1qUXS/zDhUuAYrxNC/image?height=200&width=200"
  > image.jpg
```
...
```bash
curl "http://server/api/trackedEntityInstances/ZRyCnJ1qUXS/zDhUuAYrxNC/image?dimension=medium"
```
      
#### Tracked entity instance query

<!--HRHIS4-SECTION-ID:webapi_tracked_entity_instance_query-->
...
<!--HRHIS4-SECTION-ID:webapi_tei_query_request_syntax-->
...
<!--HRHIS4-SECTION-ID:webapi_tei_query_response_format-->
...
<!--HRHIS4-SECTION-ID:webapi_tracked_entity_instance_grid_query-->
...
<!--HRHIS4-SECTION-ID:webapi_tei_grid_query_request_syntax-->
...
can look like this:
    ...
    /api/trackedEntityInstances/query.json?ou=DiszpKrYNg8

A query on all attributes for a specific value and organisation unit,
using an exact word match:

    /api/trackedEntityInstances/query.json?query=scott&ou=DiszpKrYNg8

A query on all attributes for a specific value, using a partial word
match:

    /api/trackedEntityInstances/query.json?query=LIKE:scott&ou=DiszpKrYNg8
...
space which is %20, will use a logical AND query for each
    ...
    /api/trackedEntityInstances/query.json?query=isabel%20may&ou=DiszpKrYNg8

A query where the attributes to include in the response are specified:

    /api/trackedEntityInstances/query.json?query=isabel
...
descendants organisation unit query mode:
    ...
    /api/trackedEntityInstances/query.json?attribute=zHXD5Ve1Efw:EQ:A
...
item:
    ...
    /api/trackedEntityInstances/query.json?ou=DiszpKrYNg8&program=ur1Edk5Oe2n
      &filter=lw1SqmMlnfh:GT:150:LT:190
...
program you can include a program query parameter:
    ...
    /api/trackedEntityInstances/query.json?filter=zHXD5Ve1Efw:EQ:A
...
given time span:
    ...
    /api/trackedEntityInstances/query.json?ou=O6uvpzGd5pu
...
<!--HRHIS4-SECTION-ID:webapi_tei_grid_query_response_format-->
...
<!--HRHIS4-SECTION-ID:webapi_tei_filters-->
...
<!--HRHIS4-SECTION-ID:webapi_enrollment_management-->
...
<!--HRHIS4-SECTION-ID:webapi_enrolling_tei-->
...
<!--HRHIS4-SECTION-ID:webapi_enrollment_instance_query-->
...
<!--HRHIS4-SECTION-ID:webapi_enrollment_query_request_syntax-->
...
program you can include a program query
    ...
    /api/enrollments.json?ou=O6uvpzGd5pu&ouMode=DESCENDANTS&program=ur1Edk5Oe2n

To specify program enrollment dates as part of the
    query:

    /api/enrollments.json?&ou=O6uvpzGd5pu&program=ur1Edk5Oe2n
...
you can include a tracked entity query
    ...
    /api/enrollments.json?ou=O6uvpzGd5pu&ouMode=DESCENDANTS&trackedEntity=cyl5vuJ5ETQ
...
this you can use the page and pageSize query
    ...
    /api/enrollments.json?ou=O6uvpzGd5pu&ouMode=DESCENDANTS&page=2&pageSize=3

##### Response format

<!--HRHIS4-SECTION-ID:webapi_enrollment_query_response_format-->
...
<!--HRHIS4-SECTION-ID:webapi_events-->
...
<!--HRHIS4-SECTION-ID:webapi_sending_events-->

HRHIS4 supports three kinds of events: single events with no registration
...
To send events to HRHIS4 you must interact with the *events* resource.
...
```bash
curl -d @event.xml "https://play.HRHIS4.org/demo/api/events"
  -H "Content-Type:application/xml" -u admin:district
```
...
```bash
curl -d @event.json "localhost/api/events" -H "Content-Type:application/json"
  -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_updating_events-->
...
```bash
curl -X PUT -d @updated_event.xml "localhost/api/events/ID"
  -H "Content-Type: application/xml" -u admin:district
```

```bash
curl -X PUT -d @updated_event.json "localhost/api/events/ID"
  -H "Content-Type: application/json" -u admin:district
```

#### Deleting events

<!--HRHIS4-SECTION-ID:webapi_deleting_events-->
...
```bash
curl -X DELETE "localhost/api/events/ID" -u admin:district
```

#### Assigning user to events

<!--HRHIS4-SECTION-ID:webapi_user_assign_event-->
...
<!--HRHIS4-SECTION-ID:webapi_getting_events-->

To get an existing event you can issue a GET request including the
identifier like this:

```bash
curl "http://localhost/api/events/ID" -H "Content-Type: application/xml" -u admin:district
```

#### Querying and reading events

<!--HRHIS4-SECTION-ID:webapi_querying_reading_events-->

This section explains how to read out the events that have been stored
in the HRHIS4 instance. For more advanced uses of the event data, please
...
sorting by due date
    ...
    /api/events.json?orgUnit=DiszpKrYNg8&program=eBAyeGv0exc&order=dueDate
...
discarded and the original image will be returned.
    ...
    /api/events/files?eventUid=hcmcWlYkg9u&dataElementUid=C0W4aFuVm4P&dimension=small
...
for a program stage
    ...
    /api/events/query.json?orgUnit=DiszpKrYNg8&programStage=Zj7UnCAulEk
...
<!--HRHIS4-SECTION-ID:webapi_event_filters-->
...
<!--HRHIS4-SECTION-ID:webapi_tei_update_strategies-->
...
<!--HRHIS4-SECTION-ID:webapi_tracker_bulk_deletion-->
...
curl -X POST -d @data.json -H "Content-Type: application/json"
  "http://server/api/trackedEntityInstances?strategy=DELETE"
```
...
```bash
curl -X POST -d @data.json -H "Content-Type: application/json"
  "http://server/api/enrollments?strategy=DELETE"
```
...
```bash
curl -X POST -d @data.json -H "Content-Type: application/json"
  "http://server/api/events?strategy=DELETE"
```

### Identifier reuse and item deletion via POST and PUT methods

<!--HRHIS4-SECTION-ID:webapi_updating_and_deleting_items-->
...
<!--HRHIS4-SECTION-ID:webapi_import_parameters-->
...
<!--HRHIS4-SECTION-ID:webapi_events_csv_import_export-->

In addition to XML and JSON for event import/export, in HRHIS4.17 we
...
<!--HRHIS4-SECTION-ID:webapi_sync_import_strategy-->
...
<!--HRHIS4-SECTION-ID:webapi_tracker_ownership_management-->
...
<!--HRHIS4-SECTION-ID:webapi_tracker_ownership_override_api-->
...
glass*. Currently, the temporary access is granted for 3 hours. HRHIS4
...
shown:
    ...
    /api/tracker/ownership/override?trackedEntityInstance=DiszpKrYNg8
      &program=eBAyeGv0exc&reason=patient+showed+up+for+emergency+care

#### Tracker Ownership Transfer

<!--HRHIS4-SECTION-ID:webapi_tracker_ownership_transfer_api-->
...
as shown:
    ...
    /api/tracker/ownership/transfer?trackedEntityInstance=DiszpKrYNg8
...
<!--HRHIS4-SECTION-ID:webapi_sharing-->
...
<!--HRHIS4-SECTION-ID:webapi_get_sharing_status-->
...
<!--HRHIS4-SECTION-ID:webapi_set_sharing_status-->
...
```bash
curl -d @sharing.json "localhost/api/sharing?type=dataElement&id=fbfJHSPpUQD"
  -H "Content-Type:application/json" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_schema-->
...
<!--HRHIS4-SECTION-ID:webapi_ui_customization-->

To customize the UI of the HRHIS4 application you can insert custom
...
HRHIS4 web application. This can be particularly useful in certain
situations:

  - Overriding the CSS styles of the HRHIS4 application, such as the
...
<!--HRHIS4-SECTION-ID:webapi_synchronization-->

This section covers pull and push of data and metadata.

### Data value push

<!--HRHIS4-SECTION-ID:webapi_sync_data_push-->
...
<!--HRHIS4-SECTION-ID:webapi_sync_metadata_pull-->
...
POST request with a *url* as request payload to the following resource:
    ...
    /api/synchronization/metadataPull

### Availability check

<!--HRHIS4-SECTION-ID:webapi_sync_availability_check-->
...
credentials you can make a GET request to the following resource:
    ...
    /api/synchronization/availability
      ...
      "versions": [
        {
          ...
          "demoUrl": "http://play.HRHIS4.org/demo"
        }
      ],
      "images": [
        {
...
<!--HRHIS4-SECTION-ID:webapi_data_store-->
...
<!--HRHIS4-SECTION-ID:webapi_data_store_structure-->
...
<!--HRHIS4-SECTION-ID:webapi_data_store_get_keys_and_namespaces-->
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore" -u admin:district
```
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore/foo" -u admin:district
```
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore/foo/key_1"-u admin:district
```
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore/foo/key_1/metaData" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_data_store_create_values-->
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataStore/foo/key_1" -X POST
...
<!--HRHIS4-SECTION-ID:webapi_data_store_update_values-->
...
```bash
curl "https://play.HRHIS4.org/demo/api/dataStore/foo/key_1" -X PUT -d "[1, 2, 3]"
  -H "Content-Type: application/json" -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_data_store_delete_keys-->
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore/foo/key_1" -X DELETE -u admin:district
```
...
```bash
curl "play.HRHIS4.org/demo/api/dataStore/foo" -X DELETE -u admin:district
```
...
<!--HRHIS4-SECTION-ID:webapi_data_store_sharing-->
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store-->
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_structure-->
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_get_namespaces-->
...
```bash
curl -H "Content-Type: application/json" -u admin:district "play.HRHIS4.org/api/userDataStore"
```
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_get_keys-->
...
```bash
curl -H "Content-Type: application/json" -u admin:district "play.HRHIS4.org/api/userDataStore/foo"
```
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_get_values-->
...
```bash
curl -H "Content-Type: application/json" -u admin:district "play.HRHIS4.org/api/userDataStore/foo/bar"
```
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_create_values-->
...
curl -X POST -H "Content-Type: application/json" -u admin:district -d "['some value']"
  "play.HRHIS4.org/api/userDataStore/foo/bar"
```
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_update_values-->
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_delete_key-->
...
```bash
curl -X DELETE -u admin:district "play.HRHIS4.org/api/userDataStore/foo/bar"
```
...
<!--HRHIS4-SECTION-ID:webapi_user_data_store_delete_namespace-->
...
```bash
curl -X DELETE -u admin:district "play.HRHIS4.org/api/userDataStore/foo"
```
...
<!--HRHIS4-SECTION-ID:webapi_predictors-->
...
You can interact with predictors through the `/api/predictors`
resource.
...
<!--HRHIS4-SECTION-ID:webapi_create_predictor-->
...
<!--HRHIS4-SECTION-ID:webapi_generating_predicted_values-->
...
<!--HRHIS4-SECTION-ID:webapi_min_max_data_elements-->
...
<!--HRHIS4-SECTION-ID:webapi_add_update_min_max_data_element-->
...
<!--HRHIS4-SECTION-ID:webapi_delete_min_max_data_element-->
...
<!--HRHIS4-SECTION-ID:webapi_lock_exceptions-->
...
<!--HRHIS4-SECTION-ID:webapi_tokens-->

The *tokens* resource provides access tokens to various services.

### Google Service Account

<!--HRHIS4-SECTION-ID:webapi_tokens_google_service_account-->
...
configured for HRHIS4. Please consult the installation guide for more
info.

## Analytics table hooks

<!--HRHIS4-SECTION-ID:webapi_analytics_table_hooks-->
...
<!--HRHIS4-SECTION-ID:webapi_analytics_table_hook_fields-->
...
<!--HRHIS4-SECTION-ID:webapi_create_analytics_table_hook-->
...
<!--HRHIS4-SECTION-ID:webapi_metadata_repository-->

HRHIS4 provides a metadata repository containing metadata packages with
various content. A metadata package is a HRHIS4-compliant JSON document
  ...
  "packages": [
    {
      ...
      "version": "0.1",
      "href": "https://HRHIS4.org/metadata-repo/221/sierra-leone-demo/metadata.json"
    },
    {
      ...
      "version": "0.1",
      "href": "https://HRHIS4.org/metadata-repo/221/trainingland-org-units/metadata.json"
    }
  ]
}
```
...
curl "localhost:8080/api/synchronization/metadataPull" -X POST
  -d "https://HRHIS4.org/metadata-repo/221/trainingland-org-units/metadata.json"
  -H "Content-Type:text/plain" -u admin:district
```

## Icons

<!--HRHIS4-SECTION-ID:webapi_icons-->

HRHIS4 includes a collection of icons that can be used to give visual
