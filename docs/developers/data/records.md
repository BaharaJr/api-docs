...
use the HRHIS4 demo on `http://dev.hrhis.dhis2udsm.org/demo` as basis. We assume
...
base URL to the demo API is `http://dev.hrhis.dhis2udsm.org/demo/api`. The following
...
```bash
curl -d @datavalueset.xml "https://dev.hrhis.dhis2udsm.org/demo/api/dataValueSets"
...
```bash
curl -d @datavalueset.json "https://dev.hrhis.dhis2udsm.org/demo/api/dataValueSets"
...
```bash
curl --data-binary @datavalueset.csv "https://dev.hrhis.dhis2udsm.org/demo/24/api/dataValueSets"
...
```bash
curl "https://dev.hrhis.dhis2udsm.org/demo/api/dataValueSets?dataSet=pBOMPrpg1QX&period=201401&orgUnit=DiszpKrYNg8"
...
```bash
curl "https://dev.hrhis.dhis2udsm.org/demo/api/dataValueSets?dataSet=pBOMPrpg1QX&dataSet=BfMAe6Itzgt
...
```bash
curl "https://dev.hrhis.dhis2udsm.org/demo/api/dataValues?de=s46m5MS0hxu
...
```bash
curl "https://dev.hrhis.dhis2udsm.org/demo/api/dataValues?de=s46m5MS0hxu&ou=DiszpKrYNg8
